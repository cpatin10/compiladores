...
public class ListenerMain {
    ...
    public static ArrayList<Integer> colCount;
    public static HashMap<Integer, Integer> getRow;
    public static boolean anyVariables;
    public static boolean invalidVariables;
	...
	getRow = new HashMap<>();
	anyVariables = false; invalidVariables = false;
	int last = 0, row = 0;
	String line;
	...
	try {
	    ...
	    ParseTreeWalker.DEFAULT.walk(new BackEndListener(out), tree);
	    if (!anyVariables)
		out.println("No variables -> Valid");
	    else if (!invalidVariables) 
		out.println("All variables are valid");
